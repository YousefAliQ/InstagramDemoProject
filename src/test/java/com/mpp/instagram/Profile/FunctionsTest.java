...
public class FunctionsTest {
    ...
    @Test
    public void testGetLessActivekFriendsBySessions()
    {
    ...
    @Test
    public void testGetSessionsDuration()
    {
        ...
        //Assert.assertEquals(Optional.of(Integer.MAX_VALUE),ProfileFunctions.getSessionsDuration.apply(followings,null));
